...
class TestCreatePlaylistFlow:
    ...
    def test_create_playlist_playlist_created(self):
        ...
        assert playlist.source_providers == {MusicProviders.LASTFM:
...
class TestCreatePlaylistFormSubmission:
    ...
    @pytest.mark.django_db
    @pytest.mark.parametrize('season', [PlaylistCreationForm.SUMMER,
                                        PlaylistCreationForm.WINTER,
                                        PlaylistCreationForm.FALL,
                                        PlaylistCreationForm.SPRING])
    ...
    def test_create_playlist_valid(self, auto_login_user, season, year):
        ...
        response_post = \
            client.post('/home/',
                        data={'season': str(season), 'year': str(year),
